...
WatchFaceDigital::WatchFaceDigital(Controllers::DateTime& dateTimeController,
  ...
  best_time = lv_label_create(lv_scr_act(), nullptr);
  lv_obj_align(best_time, lv_scr_act(), LV_ALIGN_CENTER, 0, 60);
  lv_obj_set_style_local_text_color(best_time, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, lv_color_hex(0x999999));
...
void WatchFaceDigital::Refresh() {
  ...
  if (currentDateTime.IsUpdated()) {
    ...
    lv_label_set_text_fmt(best_time, "%02d:%02d", t_hour, t_minute);
    lv_obj_realign(best_time);
